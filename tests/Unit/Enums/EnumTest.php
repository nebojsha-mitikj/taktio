...
{
    public function test_status_enum_ordered(): void
    {
        $this->assertEquals(['in-progress', 'to-do', 'completed'], TaskStatusEnum::ordered());
    }
    ...
    {
        $this->assertEquals(['to-do', 'in-progress', 'completed'], TaskStatusEnum::values());
    }
